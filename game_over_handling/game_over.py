...
class GameOver:
    ...
    def show_game_over_screen(self, screen, score, food, running, highest_score):
        ...
        high_score_rect = score_text.get_rect(
            center=(self.screen_width // 2-50, self.screen_height // 2 + 45))
        ...
        quit_rect = restart_text.get_rect(
            center=(self.screen_width // 2+10, self.screen_height // 2 + 95))
